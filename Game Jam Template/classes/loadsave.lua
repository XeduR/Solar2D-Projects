...
--      /_/    /____/                                                    --
--                                                                       --
--  © 2021 Spyric Games Ltd.                Last Updated: 8 August 2021  --
---------------------------------------------------------------------------
--  License: MIT                                                         --
---------------------------------------------------------------------------
...
if system.getInfo( "environment" ) == "browser" then
    ...
    -- SHA-256 pure Lua implementation by MaHuJa.
    ---------------------------------------------------------------------------
    -- Source: https://github.com/MaHuJa/CC-scripts/blob/master/sha256.lua
    ...
    local function s232num(s, i)
    	local n = 0
    	for i = i, i + 3 do n = n*256 + _byte(s, i) end
    	return n
    end
