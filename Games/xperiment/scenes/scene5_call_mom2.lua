...
function scene:create( event )
	...
	local player = display.newImage( sceneGroup, "assets/images/characters/player/mcleft1phone.png", 530, 550 )
	player.anchorY = 1
	...
	dialogue.new( "- Roughly a week later -", "Time", function()

		transition.to( cover, {alpha = 0, time = 500, onComplete=function()

			dialogue.new( "It's been a while since I've gone outside...", "Thought", function()
				dialogue.new( "...maybe I should go for a walk.", "Thought", function()
					-- Map: walk - meet oldman
