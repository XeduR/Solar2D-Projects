...
function scene:create( event )
	...
	background = display.newImage( sceneGroup, "assets/images/backgrounds/therapy_end.png", screen.minX, screen.minY )
	...
	local mask = display.newCircle( sceneGroup, 317, 189, 16 )
	mask:setFillColor( 0 )
	...
	dialogue.new( "- A couple of days later -", "Time", function()

		dialogue.new( "So, Em, how have you been doing this past month?", "Therapist", function()

			transition.to( cover, {alpha = 0, time = 500, onComplete=function()

				dialogue.new( "Fine.", "Me", function()
					dialogue.new( "Did you try out the experiment we discussed last time?", "Therapist", function()
						dialogue.new( "Yes.", "Me", function()
							dialogue.new( "So, how was it? Did you find yourself in ", "Therapist", function()
								dialogue.new( "Yes.", "Me", function()
									dialogue.new( "I see. That's wonderful. And, tell me...", "Therapist", function()
										dialogue.new( "...did you have fun?", "Therapist", function()
											mask.alpha = 0

											dialogue.new( "*Haha!*", "Me", function()
												dialogue.new( "Yes!", "Me", function()
													dialogue.new( "Yes!", "Me", function()
													end)
													transition.to( cover, {alpha = 1, time = 1500, onComplete=function()
															dialogue.remove()
