...
function scene:create( event )
	...
	local title = display.newText( groupUI, "You found a happy and loving home.", screen.centreX, screen.minY + 120, "fonts/Roboto-Black.ttf", 40 )
	title.anchorY = 0
	title:setFillColor( unpack( settings.colours.b ) )

	local text = display.newText( groupUI, "But, once your father learned of your lack of character,\nyour new family was arrested for kidnapping and you\nwere quickly returned to get a job.", screen.centreX, screen.centreY, "fonts/Roboto-Black.ttf", 36 )
	text.anchorY = 0
