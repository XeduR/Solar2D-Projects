-- Patrol boat: small, fast surface vessel.
...
function patrol.new( parentGroup, opts )
	local config = gameConfig.patrol
	opts = opts or {}

	local group = display.newGroup()
	parentGroup:insert( group )

	local color = opts.color or gameConfig.colors.patrol
